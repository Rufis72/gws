...
def requires_wtype(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        if not wtype_installed:
            raise RuntimeError(f'wtype isn\'t installed, and is required to do typing input on Wayland. Are you sure you\'ve installed it/it\'s on path as "wtype"?')
...
def requires_wayland_utils(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        if not wayland_utils_installed:
            raise RuntimeError(f'wayland_utils isn\'t installed, and is required to get monitor info on Wayland. Are you sure you\'ve installed it/it\'s on path as "wayland-info"?')
...
def requires_grim(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        if not grim_installed:
            raise RuntimeError(f'grim isn\'t installed, and is required to take screenshots on Wayland. Are you sure you\'ve installed it/it\'s on path as "grim"?')
